node('master') {
	...
	stage('Import result to Xray') {
		...
		step([$class: 'XrayImportBuilder', endpointName: '/cucumber/multipart', importFilePath: 'Xray/TargetReport/cucumber.json', importInfo: info, inputInfoSwitcher: 'fieldContent', serverInstance: xrayConnectorId])
	}
}